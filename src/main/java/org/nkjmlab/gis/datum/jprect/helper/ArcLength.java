...
class ArcLength {
	...
	static double calcArcLength(double lat) {
		...
		double k1 = 1.0 + 3.0 / 4.0 * Math.pow(Const.e, 2)
		...
		double k2 = 3.0 / 4.0 * Math.pow(Const.e, 2)
		...
		double k3 = 15.0 / 64.0 * Math.pow(Const.e, 4)
		...
		double k4 = 35.0 / 512.0 * Math.pow(Const.e, 6)
		...
		double k5 = 315.0 / 16384.0 * Math.pow(Const.e, 8)
		...
		double k6 = 693.0 / 131072.0 * Math.pow(Const.e, 10)
				+ 9009.0 / 524288.0 * Math.pow(Const.e, 12)
				+ 4099095.0 / 117440512.0 * Math.pow(Const.e, 14)
				+ 26801775.0 / 469762048.0 * Math.pow(Const.e, 16);

		double k7 = 3003.0 / 2097152.0 * Math.pow(Const.e, 12)
				+ 315315.0 / 58720256.0 * Math.pow(Const.e, 14)
				+ 11486475.0 / 939524096.0 * Math.pow(Const.e, 16);

		double k8 = 45045.0 / 117440512.0 * Math.pow(Const.e, 14)
				+ 765765.0 / 469762048.0 * Math.pow(Const.e, 16);

		double k9 = 765765.0 / 7516192768.0 * Math.pow(Const.e, 16);

		double b = lat;
		double arc = Const.ra * (1.0 - Math.pow(Const.e, 2))
				* ((k1 * b - k2 / 2.0 * Math.sin(2.0 * b)
						+ k3 / 4.0 * Math.sin(4.0 * b)
						- k4 / 6.0 * Math.sin(6.0 * b)
						+ k5 / 8.0 * Math.sin(8.0 * b)
						- k6 / 10.0 * Math.sin(10.0 * b)
						+ k7 / 12.0 * Math.sin(12.0 * b)
						- k8 / 14.0 * Math.sin(14.0 * b)
						+ k9 / 16.0 * Math.sin(16.0 * b)));
		return arc;
	}
