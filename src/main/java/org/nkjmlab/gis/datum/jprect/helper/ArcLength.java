 ...
 *
 * <p>このクラスはジャスミンソフトがApache License 2.0に基づいて公開しているscalcに由来します．
 *
 * <p>scalcは，琉球大学工学部情報工学科 宮城研究室の成果物 を，ジャスミンソフトが整理・統合したものです． 再利用を快諾
...
public class ArcLength {
  ...
  private static final double k5 =
      315.0 / 16384.0 * Math.pow(Const.e, 8)
  ...
  private static final double k6 =
      693.0 / 131072.0 * Math.pow(Const.e, 10)
  ...
  private static final double k7 =
      3003.0 / 2097152.0 * Math.pow(Const.e, 12)
          + 315315.0 / 58720256.0 * Math.pow(Const.e, 14)
          + 11486475.0 / 939524096.0 * Math.pow(Const.e, 16);

  private static final double k8 =
      45045.0 / 117440512.0 * Math.pow(Const.e, 14)
